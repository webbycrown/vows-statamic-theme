  ...
  function initMobileMenu() {
    ...
    jQuery(document).on(
      ...
      function (e) {
        ...
        if (!panel.find(".mobile-back-btn").length) {
          ...
          panel.prepend(`
              <div class="px-4">
            <button class="mobile-back-btn w-full text-left py-3 border-b border-[#B76E7933] text-thunder-100">
    ...
    $(document).on("click", "#mainmenu .mega-panel li.group > a", function (e) {
      ...
      <div id="${panelId}" class="mobile-drawer">
        <div class="px-4 py-3 border-b border-[#B76E7933] flex items-center gap-3 sticky top-0 z-9999 bg-white">
